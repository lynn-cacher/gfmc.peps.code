...
def optim_j1j2(cfg, args):
    ...
    if args.tiling == "BIPARTITE":
        def lattice_to_site(coord):
            ...
            vy = abs(coord[1])
            return ((vx + vy) % 2, 0)
    elif args.tiling == "1SITE" or args.tiling == "1SITE-STRIPE":
        def lattice_to_site(coord):
            return (0, 0)
        ...
        raise ValueError("Invalid tiling: "+str(args.tiling)+" Supported options: "\
            +"BIPARTITE, 1SITE, 2SITE, 4SITE, 8SITE, STRIPE, 1SITE-STRIPE")
    ...
    if args.instate!=None:
        ...
        if args.tiling == "BIPARTITE" or args.tiling == "2SITE" or args.tiling == "STRIPE":
        ...
        sites = {(0,0): A}
        if args.tiling in ["BIPARTITE", "2SITE", "4SITE", "8SITE", "STRIPE"]:
    ...
    if args.tiling == "BIPARTITE" or args.tiling == "2SITE" or args.tiling == "STRIPE":
    ...
    elif args.tiling == "1SITE-STRIPE":
        energy_f=model.energy_2x2_1site_stripe
        eval_obs_f= model.eval_obs_1site_stripe
        ...
        raise ValueError("Invalid tiling: "+str(args.tiling)+" Supported options: "\
            +"BIPARTITE, 2SITE, 4SITE, 8SITE, STRIPE")
